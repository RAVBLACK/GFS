...
class InvoiceAnalyzer:
    ...
    def extract_invoice_data(self, image):
        ...
        if total_tax == 0 and total_tax_from_row > 0:
            ...
            cgst = total_tax / 2
            sgst = total_tax / 2
            print(f"      Using TOTAL row tax: {total_tax_from_row}, split into CGST={cgst}, SGST={sgst}")
        ...
        print(f"      Extracted amounts - Taxable: {taxable}, CGST: {cgst}, SGST: {sgst}, IGST: {igst}, Total: {total}, Total Tax: {total_tax}")
    ...
    def _extract_total_tax_from_row(self, text):
        ...
        print(f"      DEBUG: Searching for TOTAL row in last part of text...")
            ...
            if match:
                ...
                try:
                    ...
                    if len(amounts) >= 3:
                        ...
                        print(f"      DEBUG: Sorted - Discount:{discount}, Tax:{tax}, Total:{total_amount}")
        ...
        print(f"      DEBUG: No tax found in TOTAL row")
        return 0.0
